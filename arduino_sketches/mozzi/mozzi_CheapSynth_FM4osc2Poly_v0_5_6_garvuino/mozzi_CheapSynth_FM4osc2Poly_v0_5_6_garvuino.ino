 ...
 *
 * 
 * Modified version for Garvuino https://github.com/farvardin/garvuino
...
#define LED 8 // to see if MIDI is being recieved

int switchInPin = 6;   // button to switch mode
...
void setup() {
  ...
  Serial.begin(9600); // doesn't work
...
//  case 3: // could trap different controller IDs here
 ...
 case 21: // E1 on behringer UMA25S
    changeMode();
  break;
